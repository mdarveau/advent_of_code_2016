module.exports = [
  ...
  if instructions[0] == 'value'
    return {
      command: 'value'
      value: parseInt(instructions[1])
      bot: parseInt(instructions[5])
    }
  else if instructions[0] == 'bot'
    return {
      command: 'give'
      bot: parseInt(instructions[1])
      low_to: instructions[5]
      low_to_no: parseInt(instructions[6])
      high_to: instructions[10]
      high_to_no: parseInt(instructions[11])
    }